...
exports.parsePortfolioResponse = parsePortfolioResponse;
function parsePortfolioResponse(text, timestamp) {
    ...
    for (let i = 0; i < lines.length; i++) {
        ...
        if (inPositionsSection && (lowerLine.includes('← back') ||
...
function extractTextAfter(text, pattern) {
